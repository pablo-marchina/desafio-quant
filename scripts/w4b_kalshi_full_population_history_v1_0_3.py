...
run_name="__not_main__" if os.environ.get("W4B_VALIDATE_ONLY")=="1" else "__main__"
ns={"__name__":run_name,"__file__":str(BASE_SCRIPT)}
exec(compile(src,str(BASE_SCRIPT)+"[v1.0.3-url-safe-transport-recovery]","exec"),ns,ns)
if run_name != "__main__":
    print("PASS_W4B_HISTORY_V1_0_3_PATCH_COMPILE")
