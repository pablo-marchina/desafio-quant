...
ok('No web lookup' in p['adjudication_method']['independent_context'])
ok('No review-field expansion' in p['prohibitions'])
summary={'artifact':'W2C_ADJ_SYNTHETIC_VALIDATION','version':'W2C-ADJ-SYN-v1.0','passed':passed,'failed':0,'status':f'PASS_{passed}_OF_{passed}','real_queue_read':False,'performance_data_read':False,'network_accessed':False}
