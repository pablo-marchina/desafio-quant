"""Unit of Work PostgreSQL do modulo briefing."""
...
class PostgresBriefingsUnitOfWork(BriefingsUnitOfWork):
    ...
    async def __aenter__(self) -> "PostgresBriefingsUnitOfWork":
        self._session = self._session_factory()
        self.briefing_repository = PostgresBriefingRepository(self._session)
        return self
