"""Unit of Work PostgreSQL do modulo recommendations."""
...
class PostgresRecommendationsUnitOfWork(RecommendationsUnitOfWork):
    ...
    async def __aenter__(self) -> "PostgresRecommendationsUnitOfWork":
        self._session = self._session_factory()
        self.recommendation_repository = PostgresRecommendationRepository(
            self._session
        )
        return self
